...
<div class="container-fluid mt-4 p-2 border text-center bg-light">
	<h1 class="p-3">MVC-BOARD</h1>
	<hr />
	<div class="p-2 d-flex justify-content-between">
		<span class="mt-auto" id="postCount"></span>
		<a href="writeForm.jsp"><input type="button" value="게시글 작성" class="btn btn-primary btn-sm" /></a>
	</div>
	...
	<table class="table table-hover mt-2" id="boardTable">
		...
		<c:forEach var="post" items="${boardList}">
			<tr class="my-auto">
				...
				<td class="col-4">
					<a href="contentView.do?bId=${post.bId}" class="text-dark">${post.bTitle }</a>
					<small class="text-warning">[${post.bIndent}]</small>
					<i></i>
				</td>
				<td class="col-3">${post.bDate }</td>
