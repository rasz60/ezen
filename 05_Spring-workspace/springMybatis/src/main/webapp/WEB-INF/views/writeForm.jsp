...
<h3>Write Form</h3>
	<form action="write" method="post">
		...
		<div class="form-group d-flex justify-content-end">
			...
			<button class="btn btn-sm btn-success mr-2" id="list">목록보기</button>
			<button class="btn btn-sm btn-danger mr-2" id="transaction">Ticket Transaction</button>	
		</div>
	</form>
</div>
...
$(document).ready(function() {
	...
	$('.justify-content-end button').click(function(e) {
		e.preventDefault();
