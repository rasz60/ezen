 ...
 * Generated at: 2022-03-21 07:09:07 UTC
...
public final class board_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		<a href=\"write_view\" id=\"write\" class=\"btn btn-sm btn-dark float-right mt-4\">글작성</a>\r\n");
      out.write("	</div>\r\n");
      out.write("	<hr />\r\n");
      out.write("	\r\n");
      ...
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	$('.content_view').click(function(e) {\r\n");
      out.write("		$('#searchForm').css(\"visibility\", \"hidden\");		\r\n");
      out.write("\r\n");
      out.write("		e.preventDefault();\r\n");
      out.write("		\r\n");
      ...
      out.write("		$('#searchTable tbody tr').filter(function() {\r\n");
      out.write("			// 게시글 정보에 value 값을 가지고 있는 것만 남기고 toggle\r\n");
      ...
      out.write("			console.log(page + ' (from options)');\r\n");
      out.write("			$('.page-link').on('click', function(e) {\r\n");
      out.write("				e.preventDefault();\r\n");
      out.write("				var pageNo = $(this).text();\r\n");
      out.write("				var purl;\r\n");
      out.write("				if ( pageNo != 'First' && pageNo != 'Previous' && pageNo != 'Next' && pageNo != 'Last') {\r\n");
      out.write("					purl = 'plist?pageNo=' + pageNo;\r\n");
      out.write("				} else {\r\n");
      out.write("					return;\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      ...
      out.write("					},\r\n");
      out.write("					error: function(data) {\r\n");
      out.write("						alert('plist 에러 발생');\r\n");
      out.write("					}\r\n");
      out.write("				}); //ajax close\r\n");
      out.write("			}); //.page-link click event close\r\n");
      out.write("		} //page click function close\r\n");
      out.write("	}) //window.pagObj close\r\n");
      out.write("	\r\n");
      out.write("	.on('page', function(event, page) {\r\n");
      out.write("		console.log(page + ' (from event listening)');\r\n");
      out.write("	}); //on method close\r\n");
      out.write("});\r\n");
      out.write("</script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board.jsp(69,3) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/board.jsp(69,3) '${listContent}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${listContent}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/board.jsp(69,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/board.jsp(74,6) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setBegin(1);
      // /WEB-INF/views/board.jsp(74,6) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
